(function () {
  ...
  var x = angular.module('app.core', []);

  function CoreController($scope, $location, $http, $firebaseObject, $firebaseArray, $firebaseAuth, Auth, $routeParams) {
  ...
  x.controller('CoreController', CoreController);
